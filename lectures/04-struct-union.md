...
Сборка: C++20, -O2, Google Benchmark. Заголовок packing-benchmark-types.h лежит рядом с исходниками. Ссылка Quick Bench содержит оба теста и определение типов в одном файле, выбирает GCC 13.2, C++20 и -O2.
